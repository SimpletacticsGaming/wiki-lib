...
values (5, 'Frage 1', 'Beschreibung 1', '2023-10-21', 'false',
...
VALUES (1, 'Thema for poll 2', ARRAY [2,6]);
INSERT INTO wiki_poll (id, question, description, end_date, ended, data)
values (2, 'This is a test', 'Test description', '2023-10-21', 'false',
...
INSERT INTO wiki_poll (id, question, description, end_date, ended, data)
values (4, 'This is a test', '', '2099-09-24', 'false',
        '[{"votes": [{"userId": "1", "date": "2023-10-21T00:00", "option": "FALSE"}], "pollOption": {"text": "testCase", "uuid": "ddb11436-bdc8-4488-87f6-fsdfsd"}}]');
INSERT INTO wiki_poll (id, question, description, end_date, ended, data)

...
class WikiAdapter(
    ...
    override fun getTopic(id: Int, hasAccess: () -> Boolean): TopicEntity? {
        ...
        throw WikiAccessDeniedException("Access denied to get topic for id $id")
    }
    ...
    override fun createTopic(parentId: Int, topic: String, hasAccess: () -> Boolean): Int {
        ...
        throw WikiAccessDeniedException("Access denied for creating topic for parentId $parentId")
    }
    ...
    override fun updateTopic(id: Int, topic: String, hasAccess: () -> Boolean): Int {
        ...
        throw WikiAccessDeniedException("Access denied for updating topic with id $id")
    }
    ...
    override fun deleteTopic(id: Int, hasAccess: () -> Boolean) {
        ...
        throw WikiAccessDeniedException("Access denied for deleting topic for id $id")
    }
    ...
    override fun getEntry(id: Int, hasAccess: () -> Boolean): EntryEntity? {
        ...
        throw WikiAccessDeniedException("Access denied for getting entry with id $id")
    }

    @Transactional
    override fun createEntry(topicId: Int, headline: String, body: String, hasAccess: () -> Boolean): Int {
        if (hasAccess.invoke()) {
        ...
        throw WikiAccessDeniedException("Access denied for creating entry with id $topicId")
    }

    @Transactional
    override fun updateEntry(id: Int, headline: String, body: String, hasAccess: () -> Boolean): Int {
        if (hasAccess.invoke()) {
            val wikiType = wikiSqlAdapter.getWikiType(id)
        ...
        throw WikiAccessDeniedException("Access denied for updating entry with id $id")
    }
    ...
    override fun deleteEntry(id: Int, hasAccess: () -> Boolean) {
        ...
        throw WikiAccessDeniedException("Access denied for deleting entry with id $id")
    }
    ...
    override fun getWikiType(id: Int, hasAccess: () -> Boolean): WikiType? {
        ...
        throw WikiAccessDeniedException("Access denied for getting type with id $id")
    }
